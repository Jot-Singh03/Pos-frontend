...
const DropdownsManagement: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingCategory) {
        await updateCategory(editingCategory._id, { name: formName });
      } else {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {loading ? (
            <div style={{ textAlign: 'center', color: theme.colors.gray[500] }}>Loading...</div>
          ) : (
            <ul style={{
              listStyle: 'none',
              padding: 0,
              ...
              {categories.map(cat => (
                <li
                  ...
                  onMouseOver={e => (e.currentTarget.style.background = theme.colors.gray[100])}
                  onMouseOut={e => (e.currentTarget.style.background = 'transparent')}
                >
                  <span style={{ fontSize: theme.fontSizes.base }}>{cat.name}</span>
